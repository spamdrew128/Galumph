...
pub fn test_postions() -> Vec<PerftTest> {
    ...
    PerftTest::new("8/8/8/3p4/4pn1N/6p1/8/5K1k w - - 10 1", vec![5, 55, 390, 3895, 27806, 281422]),
    PerftTest::new("8/8/8/3p4/5n2/4p3/6pk/4KN2 b - - 3 1", vec![7, 21, 275, 1354, 18520, 118617]),
    PerftTest::new("rnbq1b1r/ppPknQ1p/3pp3/1B6/5pp1/BP2P3/P1PK1PPP/RN4NR b - - 4 1", vec![2, 92, 1705, 74474]),
    ...
    PerftTest::new("4k3/3r4/8/2pP4/8/8/3K4/8 w - c6 0 1", vec![9, 133, 930]),
    PerftTest::new("4k3/5b2/8/2pP4/8/8/K7/8 w - c6 0 1", vec![5, 50, 299]),
    PerftTest::new("4k3/1b6/8/2pP4/8/8/6K1/8 w - c6 0 1", vec![9, 96, 630]),
    ...
    PerftTest::new("4k3/3r4/8/3Pp3/8/8/3K4/8 w - e6 0 1", vec![9, 133, 930]),
    PerftTest::new("4k3/5b2/8/3Pp3/8/8/K7/8 w - e6 0 1", vec![6, 57, 357]),
    PerftTest::new("4k3/1b6/8/3Pp3/8/8/6K1/8 w - e6 0 1", vec![8, 88, 543]),
    ...
    PerftTest::new("6k1/3K4/8/2pP4/8/8/3r4/8 w - c6 0 1", vec![9, 149, 954]),
    PerftTest::new("4k1K1/8/8/2pP4/8/1b6/8/8 w - c6 0 1", vec![3, 34, 173]),
    PerftTest::new("4k1K1/8/8/2pP4/8/1q6/8/8 w - c6 0 1", vec![3, 76, 357]),
...
mod tests {
    ...
    fn test_fen() {
        ...
        board.simple_try_play(Move::from_str("a1a8", &board).unwrap());
